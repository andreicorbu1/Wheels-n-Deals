...
public class ExceptionHandlingMiddleware
{
    ...
    public async Task InvokeAsync(HttpContext context)
    {
        ...
        {
            await RespondToExceptionAsync(context, HttpStatusCode.Forbidden, ex.Message + ' ' + ex.InnerException?.Message, ex);
        }
        catch (ResourceMissingException ex)
        {
            await RespondToExceptionAsync(context, HttpStatusCode.NotFound, ex.Message + ' ' + ex.InnerException?.Message, ex);
        }
